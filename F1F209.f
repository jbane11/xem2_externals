...
! Modified value by DG to improve agreement with XEM data
c      if(a.gt.2.5 .and. a.lt.3.5) p18 = 47.0
! special case for 4He
      if(a.gt.3.5 .and. a.lt.4.5) p18 = 170.
! Modified value by DG to improve agreement with XEM data
c      if(a.gt.3.5 .and. a.lt.4.5) p18 = 145.
...
C DG: had to add this to avoid NAN
      f1=0.0
      f2=0.0
      if(w2.lt.0.0) return
C DG end addtion
