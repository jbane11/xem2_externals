...
! z in cm relative to center
 ...
 123    format(1x,'TUNA rad len=',7f10.5)
     ...
     >    *TWALL/(ECOR-ECIR)                   ! & end cap
        ...
        nprnt= nprnt+1
        if(nprnt.le.6) write(*,124) tcm,tbal,tbefor,tafter,taal
...
c! used to be Called from cexternal.c
...
c     Begins by asking for the inp file, located in the INP dir.
c     makes sure the name is formated correct with dir. and .inp
...
c     open the inp file  read in the information and write to stdout
